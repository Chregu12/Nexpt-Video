...
SFX=out/sfx-original.wav
WAV=out/audio-rework-preview.wav
M4A=out/audio-rework-preview.m4a
VIDEO_IN=out/NEXPT-Keynote-ANIMATIC-OHNE-STIMME.mp4
VIDEO_OUT=out/NEXPT-AUDIO-REWORK-PREVIEW.mp4
...
"$FF" -hide_banner -loglevel error -y \
  ...
  -filter_complex "\
    ...
    [ducked][effects]amix=inputs=2:normalize=0,\
      highpass=f=28,alimiter=limit=0.96,\
      loudnorm=I=-16:TP=-1.0:LRA=9[out]" \
